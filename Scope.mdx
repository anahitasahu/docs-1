...
company:write    | Permission to write the company's information.|
| company:activity:read    | Permission to read information regarding the company's activity.  | Permission to read the name the company is using to do business. |
| company:legalName:read   | Permission to read the company's legal name.|
| company:address:read    | Permission to read the company's address.  
